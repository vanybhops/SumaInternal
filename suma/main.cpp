...
int destroyImGui(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	kiero::shutdown();
	pDevice->Release();
	pContext->Release();
...
HRESULT __stdcall hkPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	...
	ImGui::Begin("Suma menu");

	ImGui::SetWindowSize(ImVec2{ 200, 280 });

	if (ImGui::Button("uninjectz", ImVec2{100,50}))
	{
		return destroyImGui(pSwapChain, SyncInterval, Flags);
	}
	ImGui::End();
